...
import EditPendingRequestModal from "./EditPendingRequestModal";
        ...
        <>
                ...
                return (
                    <div ref={detailRef} className="glass" style={{
                        ...
                        <div style={{
                            ...
                            {/* Submitter Actions: Edit & Cancel */}
                            {(req.submittedBy?.username === currentUsername) && (
                                <div style={{ display: "flex", gap: "0.75rem", marginRight: "auto" }}>
                                    {/* Edit Button - only for CREATE and UPDATE */}
                                    {(req.type === 'CREATE' || req.type === 'UPDATE') && (
                                        <button
            ...
            {editingRequest && (
                <EditPendingRequestModal
                    ...
                    requestType={editingRequest.type}
                    data={editingRequest.data}
                    submitReason={editingRequest.submitReason || null}
